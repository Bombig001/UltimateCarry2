...
namespace UltimateCarry
{
    class RecallInfo
    {
        ...
        {
            string drawtext = EnemyInfo.Player.ChampionName + ": " + Recall.Status; //change to better string
	...
	class BaseUlt
	{
        ...
        public static float GetSpellTravelTime(Obj_AI_Hero source, float speed, float delay, Vector3 targetpos)
        {
            ...
            if (source.ChampionName == "Jinx" && distance > 1350) //1700 = missilespeed, 2200 = missilespeed after acceleration, 1350 acceleration starts, 1500 = fully accelerated
            {
